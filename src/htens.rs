...
impl Htens {
    ...
    fn torsion(
        ...
        for k in 0..3 {
            for i in 0..3 {
                let w6 = h43[(i, k)] + e23[i] * w5 * h.h411[(2, 0, k)];
                for j in 0..3 {
        ...
        for k in 0..3 {
            for i in 0..3 {
                let w6 = h21[(i, k)] - e23[i] * w5 * h.h411[(2, 1, k)];
                for j in 0..3 {
        ...
        for k in 0..3 {
            for j in 0..=k {
                for i in 0..=j {
                    h.h111[(i, j, k)] -= 2.0 * h11[(j, k)] * h.h411[(0, 0, i)];
                    h.h444[(i, j, k)] -= 2.0 * h44[(j, k)] * h.h411[(0, 1, i)];
                }
            }
        } // end 222
        fill3a(&mut h.h111, 3);
        ...
        for i in 0..3 {
            ...
            for j in 0..3 {
                for k in 0..3 {
                    ...
                    h.h123[(i, j, k)] -= h21[(j, i)] * h.h411[(0, 2, k)];
                    h.h432[(i, j, k)] -= h43[(i, j)] * h.h411[(1, 0, k)];
                }
            }
        } // end 227
        ...
        for k in 0..3 {
            for j in 0..3 {
                for i in 0..3 {
                    h.h223[(i, j, k)] -= c15 * h21[(i, j)] * h.h411[(2, 0, k)];
                    h.h332[(i, j, k)] -= c16 * h43[(j, i)] * h.h411[(2, 1, k)];
                }
            }
        } // end 242
        ...
        let w6 = c8 * t34 * c14;
        for k in 0..3 {
            h.h411[(0, 0, k)] = w5 * bp33[k] + w6 * e23[k] + w4 * e34[k];
            h.h411[(0, 1, k)] = w2 * bp22[k] - w3 * e23[k] + w1 * e21[k];
            h.h411[(0, 2, k)] = -w1 * e21[k] - w2 * bp22[k] + w3 * e23[k];
            h.h411[(1, 0, k)] = -w4 * e34[k] - w5 * bp33[k] - w6 * e23[k];
        } // end 260

        for k in 0..3 {
            for j in 0..3 {
                for i in 0..3 {
                    h.h223[(i, j, k)] += h42[(j, i)] * h.h411[(0, 0, k)];
                    h.h332[(i, j, k)] += h31[(i, j)] * h.h411[(0, 1, k)];
                }
            }
        } // end 267
    ...
    fn lin1(
        ...
        for k in 0..3 {
            for j in 0..3 {
                for i in 0..3 {
                    h.h221[(i, j, k)] =
                        h11[(i, j)] * (v1[k] * tanth - e21[k] / t21);
                    h.h221[(i, j, k)] += v1[k] * v1[j] * e21[i] * tanth / t21
                        - (h11a[(i, j)] * v1[k]) / t21;
                    h.h223[(i, j, k)] =
                        h33[(i, j)] * (v3[k] * tanth - e23[k] / t23);
                    h.h223[(i, j, k)] += v3[k] * v3[j] * e23[i] * tanth / t23;
